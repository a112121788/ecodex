...
| Delivery | CI、release workflow、docs、CONTRIBUTING、SECURITY、安装更新路径已具备 | `04-build-deploy.md`、`md/` |
...
| 配置模板化 | `.ecodex/ecodex.json` 提供 build/test/md/release 常用命令 | 新贡献者 5 分钟可打开命令面板执行 |
...
| ID | 风险 | 严重度 | 触发信号 | 策略 |
|---|---|---|---|---|
| R-01 | AI loop 自动扩大范围 | High | 单轮修改跨 Core/UI/CLI/md/release 多层 | WIP=1；超过 2 天必须拆 |
...
旧版 M0-M7 已完成并作为 1.0 基线保留在 `CHANGELOG.md` 与 `md/roadmap.md`：
